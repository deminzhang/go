...
// 奇门三元
var sanYuanName = []string{"", "上元", "中元", "下元"}
var jieQiIndex = map[string]int{
	"冬至": 1, "小寒": 2, "大寒": 3,
	"立春": 4, "雨水": 5, "惊蛰": 6,
	"春分": 7, "清明": 8, "谷雨": 9,
	"立夏": 10, "小满": 11, "芒种": 12,
...
var Gua8Gong9 = []string{"", "坎", "坤", "震", "巽", "  ", "乾", "兑", "艮", "离"}

var QM3Q6Y = []string{"戊", "已", "庚", "辛", "壬", "癸", "丁", "丙", "乙"} //三奇六仪
