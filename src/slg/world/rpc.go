...
func init() {
	...
	Net.RegRPC(Const.View_C, func(ss Net.Session, pid int32, data []byte, uid int64) {
		ps := protos.View_C{}
	...
	Net.RegRPC(Const.CityMove_C, func(ss Net.Session, pid int32, data []byte, uid int64) {
